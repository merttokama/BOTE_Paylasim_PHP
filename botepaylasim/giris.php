...
<div class="main">
  ...
  <form action="girisyap.php" method="post" id="contactform">
    <ol>
      <li>
      ...
      <li class="buttons">
        <input name="buton" type="submit" class="button" value="giriş yap" />
      </li>
    </ol>
    Üye değilseniz lütfen <a href="kayit.php">kayıt olunuz. </a>
  </form>
  </div>
  <div class="footer">
